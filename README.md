...
<p align="center">
  <strong>Machine Learning Researcher | FinTech + AI Builder | CS + Applied Math @ UT Austin</strong><br>
  Passionate about applied ML, quantitative modeling, and building scalable systems for real-world change.
</p>
...
- **ML Research** @ UT Southwestern  
- **Computational Biology** @ Texas Christian University  
- **Private Equity Analyst** @ NewShore Capital  
- **FinTech Builder** @ Fidutam  
- **Quantitative Research** @ hScore  
